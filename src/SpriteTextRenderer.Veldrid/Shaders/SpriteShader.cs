...
/*
[assembly: ShaderSet("SpriteShader", "DEngine.Shaders.SpriteShader.VS", "DEngine.Shaders.SpriteShader.FS")]
...
namespace DEngine.Shaders
{
    public class SpriteShader
    {
        ...
        [VertexShader]
        public GeometryOutput VS(VertexInput input)
        {
            return input;
        }
        ...
        public struct VertexInput
        {
            [TextureCoordinateSemantic] public Vector2 TexCoord;
            [ColorSemantic] public Vector4 Color;
            [TextureCoordinateSemantic] public Vector2 TexCoordSize; // TEXCOORDSIZE
            [PositionSemantic] public Vector2 TopLeft; // TOPLEFT
            [PositionSemantic] public Vector2 TopRight; // TOPRIGHT
            [PositionSemantic] public Vector2 BottomLeft; // BOTTOMLEFT
            [PositionSemantic] public Vector2 BottomRight; // BOTTOMRIGHT
        }
